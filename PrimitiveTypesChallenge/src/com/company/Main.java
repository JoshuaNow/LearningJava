...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // create and int variable and set it to any valid int number . Lastly , create
        // a variable of type long
        // and make it equal to 50000 plus 10 times the sum of the byte plus the short
        ...
        // for this one we have to cast because the short doesn't know if I can accept a
        // number form int since it
        // maybe to large
    }
}
